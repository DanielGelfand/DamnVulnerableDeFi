...
describe.only('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        const AttackFactory = await ethers.getContractFactory('AttackFreeRider', deployer);
        ...
        await this.attack.connect(attacker).flashLoan();
